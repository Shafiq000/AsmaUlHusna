...
const NameCard = memo(
  ({
    ...
    return (
      ...
      >
        <View style={[styles.box, themeMode == "dark" && { backgroundColor: "#FFF" }]}>
          <Text style={[styles.id, themeMode == "dark" && { color: "#000" }]}>
            {item.id}
          </Text>
        </View>
  ...
  return (
    ...
    >
      <View style={styles.mainHeader}>
        <Text style={styles.toptext}>99 Names of Allah</Text>
      ...
      <View style={styles.bodyContainer}>
        <Text
          style={[
            styles.headerTextSubTitle,
            themeMode == "dark" && { color: "#FFF" },
          ]}
        >
          {headerTextSubTitle}
        </Text>
        <Text style={[styles.headerText, themeMode == "dark" && { color: "#FFF" }]}>{headerText}</Text>
